...
import { contactLinks, techStack } from "../data/shared";
...
const interests = [
	{
		...
		detail:
			"Dragging Brighton to European glory, one painstaking save at a time.",
	},
	{
		index: "02",
		title: "Music & Film",
		detail:
			"Happy to talk for hours about a favorite album or an underrated movie.",
	},
	{
		index: "03",
		title: "Side Projects",
		detail:
			"Personal builds where I test new tools without a deadline. Lately: an Astro portfolio and a wedding invitation site.",
	},
];
				...
				<section className="grid lg:grid-cols-[1.4fr_1fr] gap-12 lg:gap-16 items-start">
					<div className="animate-on-scroll">
						...
						<h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl tracking-tight leading-[1.05] text-white">
							I build <span className="text-emerald-500">type-safe</span>, fast
							web applications.
						</h1>
						<p className="font-body text-lg text-[#94A3B8] leading-relaxed mt-6 max-w-[60ch]">
							I&apos;m a software engineer based in Jakarta, Indonesia. I work
							across{" "}
							<span className="text-white font-medium">8+ languages</span> —
							TypeScript, Python, Dart, Vue, and more — turning complex
							requirements into interfaces that feel quick and effortless, with{" "}
							<span className="text-white font-medium">React</span> and{" "}
							<span className="text-white font-medium">TypeScript</span> at the
							core.
						</p>
					</div>

					{/* Profile spec card */}
					<div className="animate-on-scroll relative bg-[#0F1115] border border-white/10 rounded-2xl p-8 hover:border-emerald-500/40 hover:shadow-[0_0_30px_-10px_rgba(16,185,129,0.2)] transition-transform transition-shadow duration-300">
				...
				<section className="grid md:grid-cols-[auto_1fr] gap-8 md:gap-16 mt-28 md:mt-32">
					...
					<div className="animate-on-scroll space-y-6 max-w-[65ch]">
						<p className="font-body text-lg text-[#94A3B8] leading-relaxed">
							...
							<span className="text-white font-medium">Pimcore and Nextjs</span>{" "}
							to ship robust solutions, partnering closely with business
							analysts and end users so the product fits how people actually
							work. I care about type safety, performance, and the small
							interaction details that make software feel considered.
						</p>
						<p className="font-body text-lg text-[#94A3B8] leading-relaxed">
				...
				<section className="grid md:grid-cols-[auto_1fr] gap-8 md:gap-16 mt-28 md:mt-32">
					...
					<div className="animate-on-scroll flex flex-wrap gap-2.5">
						{techStack.map((tech) => (
							<span
								key={tech}
								className="font-mono text-sm text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-lg hover:bg-emerald-500/20 hover:border-emerald-500/40 transition-all duration-200"
							>
								{tech}
							</span>
						))}
					...
					<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
						<div>
							...
							<p className="font-body text-[#94A3B8] mt-2 max-w-[45ch]">
								Open to remote roles and collaborations. The fastest way to
								reach me is email.
							</p>
						</div>

						<div className="flex flex-wrap gap-3 shrink-0">
							{contactLinks.map(({ label, href, primary, external }) => (
								<a
									key={label}
									href={href}
									{...(external
