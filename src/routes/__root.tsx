	...
	head: () => ({
		meta: [
			...
			},
			{
				name: "description",
				content:
					"Grarizki's portfolio showcasing web development skills using React, TypeScript, and modern frontend technologies.",
			},
		],
		links: [
			{
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&family=Geist:wght@400;500;600&display=swap",
			},
		],
	}),
...
function RootDocument() {
	return (
		<html lang="en" className="dark" suppressHydrationWarning>
			<head>
				<HeadContent />
				{/* Prevent theme flash: set class before paint */}
				<script
