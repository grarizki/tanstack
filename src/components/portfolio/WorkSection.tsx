			...
			<div className="relative max-w-screen-lg mx-auto">
				...
				<div className="flex flex-col gap-12">
					{works.map((work, idx) => (
						<div
							key={work.company}
							className={`animate-on-scroll relative flex flex-col md:flex-row gap-8 ${
						...
						>
							...
							<div className="md:w-1/2 group">
								<div className="relative bg-[#0F1115] border border-white/10 rounded-2xl p-8 hover:-translate-y-1 hover:border-emerald-500/40 hover:shadow-[0_0_30px_-10px_rgba(16,185,129,0.2)] transition-transform transition-shadow duration-300">
									{/* Corner accents */}
