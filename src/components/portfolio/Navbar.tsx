        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden sm:flex items-center gap-8">
            ...
            <a
              ...
              className="font-mono text-xs font-bold uppercase tracking-widest bg-gradient-to-r from-emerald-600 to-emerald-500 text-white px-5 py-2 rounded-full shadow-[0_0_20px_-5px_rgba(5,150,105,0.5)] hover:shadow-[0_0_30px_-5px_rgba(16,185,129,0.6)] hover:scale-105 transition-all duration-300"
            >
              Contact
            </a>
          </div>
          ...
          <div className="flex sm:hidden items-center gap-3">
            <a
              href="mailto:raka.grarizki@gmail.com"
              className="font-mono text-xs font-bold uppercase tracking-widest bg-gradient-to-r from-emerald-600 to-emerald-500 text-white px-4 py-2 rounded-full transition-all duration-300"
            >
              Contact
            </a>
            <button
