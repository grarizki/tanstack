...
const projects = [
  {
    ...
    description: 'Redesigned the company website with a modern, mobile-first approach. Improved user engagement by 20% and reduced page load time by 40%.',
  ...
  },
  {
    ...
    description: 'Built a data-intensive internal tool for monitoring business metrics, featuring real-time updates and complex data visualisations.',
  ...
  },
  {
    ...
    description: 'Developed a self-service portal for customers to manage loan applications and documents, reducing support tickets by 30%.',
...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="scroll-mt-24 relative z-10 py-24" ref={sectionRef}>
      {/* Section header */}
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-screen-lg mx-auto">
        {projects.map((project) => (
          <a
            key={project.title}
            href={project.href}
            className="animate-on-scroll group relative bg-[#0F1115] border border-white/10 rounded-2xl p-7 flex flex-col gap-4 hover:-translate-y-1 hover:border-emerald-500/40 hover:shadow-[0_0_30px_-10px_rgba(16,185,129,0.2)] transition-all duration-300 cursor-pointer"
          >
            {/* Corner accents */}
