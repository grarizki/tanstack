...
import { contactLinks } from "../data/shared";
				...
				<section className="grid lg:grid-cols-[1.4fr_1fr] gap-12 lg:gap-16 items-start">
					<div className="animate-on-scroll">
						...
						<p className="font-body text-lg text-[#94A3B8] leading-relaxed mt-6 max-w-[60ch]">
							Across fintech and software consulting, I work with React,
							TypeScript, Dart, and Python — redesigning interfaces, going
							mobile-first, and squeezing out performance. Work that moved real
							engagement, conversion, and load-time numbers.
						</p>
					</div>
						...
						<div className="flex flex-col gap-10 md:gap-12">
							{workExperience.map((work) => (
								...
								>
									...
									<div className="group relative bg-[#0F1115] border border-white/10 rounded-2xl p-8 hover:-translate-y-1 hover:border-emerald-500/40 hover:shadow-[0_0_30px_-10px_rgba(16,185,129,0.2)] transition-transform transition-shadow duration-300">
										<span className="absolute top-3 left-3 w-3 h-3 border-t border-l border-emerald-500/60" />
										<span className="absolute bottom-3 right-3 w-3 h-3 border-b border-r border-emerald-500/60" />
					...
					<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
						<div>
							...
							<p className="font-body text-[#94A3B8] mt-2 max-w-[45ch]">
								I&apos;m open to remote roles and collaborations. Let&apos;s
